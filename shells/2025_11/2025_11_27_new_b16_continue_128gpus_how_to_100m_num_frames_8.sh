...
torchrun --master_addr $master_addr --master_port $master_port \
  ...
  --init_backbone ${INIT_BACKBONE} \
  --list_init_partial_fc_paths /video_vit/checkpoint_llava_vit/2025_11_23_new_b16_continue_80gpus_how_to_100m_num_frames_16/00076000/llava_vit_si_ssd/llava_vit_si_ssd_%03d.pt NULL  \
