...
torchrun --master_addr $master_addr --master_port $master_port \
  ...
  --list_init_partial_fc_paths /video_vit/checkpoint_llava_vit/new_l14_mlcd_pretrain_continue_448px/00158692/llava_vit_si_ssd/llava_vit_si_ssd_%03d.pt NULL  \
