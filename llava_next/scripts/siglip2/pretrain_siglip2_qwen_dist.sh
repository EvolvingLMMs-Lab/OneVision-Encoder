...
BASE_RUN_NAME="llavanext-siglip2packing_-2hidnorm-qwen2.5-1.5b-instruct-pretrain_blip558k_plain-1220-dist"
echo "BASE_RUN_NAME: ${BASE_RUN_NAME}"

deepspeed --hostfile /vlm/yinxie/code/LLaVA-ViT/hostfile_anlast6nodes.txt \
    --master_port 65535 \
