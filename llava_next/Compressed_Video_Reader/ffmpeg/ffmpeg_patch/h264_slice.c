                           ...
                           const H2645NAL *nal)
{
    ...
    /*
     * CVR: When exporting MV/Residual and writing residual as pixels (e.g. dst = 128 + residual),
     * deblocking would smooth/alter the residual buffer. Disable loop filter unconditionally.
     */
    sl->deblocking_filter = 0;
    h->postpone_filter = 0;
