...
#if BIT_DEPTH == 8
#define RESIDUAL_OFFSET 128
#elif BIT_DEPTH == 10
#define RESIDUAL_OFFSET 512
#elif BIT_DEPTH == 12
#define RESIDUAL_OFFSET 2048
#endif
                                          ...
                                          idctin *col)
{
    ...
    dest[0] = av_clip_pixel(RESIDUAL_OFFSET + ((int)(a0 + b0) >> COL_SHIFT));
    dest += line_size;
    dest[0] = av_clip_pixel(RESIDUAL_OFFSET + ((int)(a1 + b1) >> COL_SHIFT));
    dest += line_size;
    dest[0] = av_clip_pixel(RESIDUAL_OFFSET + ((int)(a2 + b2) >> COL_SHIFT));
    dest += line_size;
    dest[0] = av_clip_pixel(RESIDUAL_OFFSET + ((int)(a3 + b3) >> COL_SHIFT));
    dest += line_size;
    dest[0] = av_clip_pixel(RESIDUAL_OFFSET + ((int)(a3 - b3) >> COL_SHIFT));
    dest += line_size;
    dest[0] = av_clip_pixel(RESIDUAL_OFFSET + ((int)(a2 - b2) >> COL_SHIFT));
